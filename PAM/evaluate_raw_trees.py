...
if __name__ == "__main__":
    ...
    files = {
        "Global": "tree_global_alignment.nwk",
        "Local": "tree_local_alignment.nwk",
        "SemiGlobal": "tree_semi-global_alignment.nwk",
        "MSA": "tree_msa.nwk",
        "MSA (Muscle)": "tree_muscle_msa.nwk"
    }
    ...
    pairs = [("Global", "Local"), ("Global", "SemiGlobal"), ("Local", "SemiGlobal"), ("Global", "MSA"), ("Local", "MSA"), ("SemiGlobal", "MSA"), ("MSA", "MSA (Muscle)"), ("Global", "MSA (Muscle)"),  ("Local", "MSA (Muscle)"), ("SemiGlobal", "MSA (Muscle)")]
    for t1, t2 in pairs:
        try:
            rf = calculate_rf_distance(files[t1], files[t2])
            print(f"{t1} vs {t2}: {rf}")
        except:
            pass
